...
export const translations: Record<string, Translations> = {
  en: {
    ...
    messages: {
      ...
      needSolForTransactions: "You need at least 0.00016 SOL available to lock or unlock tokens. Add SOL, then disconnect and reconnect your wallet to try again.",
  ...
  zh: {
    ...
    messages: {
      ...
      needSolForTransactions: "在会员账户和保险库均已创建后，锁定或解锁代币需要至少0.00016 SOL。请添加SOL后断开并重新连接钱包再试。",
